...
function Main() {
  ...
  return (
    <>
      ...
      <TodoSection todos={todos} isActive={true} onClickChange={onClickChange} onClickRemove={onClickRemove} />
      <TodoSection todos={todos} isActive={false} onClickChange={onClickChange} onClickRemove={onClickRemove} />
      </>
  )
}
